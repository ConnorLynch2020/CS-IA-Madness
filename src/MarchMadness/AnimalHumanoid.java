 ...
 * @author 1029983
 */
public class AnimalHumanoid extends javax.swing.JDialog {

    /**
     * Creates new form AnimalHumanoid
     */
    public AnimalHumanoid(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnimalHumanoid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AnimalHumanoid dialog = new AnimalHumanoid(new javax.swing.JFrame(), true);
