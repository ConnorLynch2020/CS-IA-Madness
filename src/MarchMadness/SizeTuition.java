 ...
 * @author 1029983
 */
public class SizeTuition extends javax.swing.JDialog {

    /**
     * Creates new form SizeTuition
     */
    public SizeTuition(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SizeTuition.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SizeTuition dialog = new SizeTuition(new javax.swing.JFrame(), true);
