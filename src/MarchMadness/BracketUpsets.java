 ...
 * @author 1029983
 */
public class BracketUpsets extends javax.swing.JDialog {

    /**
     * Creates new form BracketUpsets
     */
    public BracketUpsets(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BracketUpsets.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BracketUpsets dialog = new BracketUpsets(new javax.swing.JFrame(), true);
