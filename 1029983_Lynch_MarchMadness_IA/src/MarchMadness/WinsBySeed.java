 ...
 * @author 1029983
 */
public class WinsBySeed extends javax.swing.JDialog {

    /**
     * Creates new form WinsBySeed
     */
    public WinsBySeed(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WinsBySeed.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WinsBySeed dialog = new WinsBySeed(new javax.swing.JFrame(), true);
